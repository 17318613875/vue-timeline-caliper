(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-timeline-caliper"] = factory(require("vue"));
	else
		root["vue-timeline-caliper"] = factory(root["Vue"]);
...
function PointTime(time) {
  var A = function A(num) {
    return ("00" + num).slice(-2);
  };

  var B = function B(num) {
    return ("000" + num).slice(-3);
  };

  var t = new Date(Math.floor(1e3 * time)),
      a = t.getUTCHours(),
      n = t.getUTCMinutes(),
      i = t.getUTCSeconds(),
      o = Math.floor(1000 * time) % 1000,
      r = "".concat(A(n), ":").concat(A(i), ".").concat(B(o));
  return "".concat(A(a), ":").concat(r);
}

function DrawTimeLineItem(ctx, _ref, time, unit) {
  ...
  if (time || time === 0) {
    ...
    ctx.fillStyle = "#333";
    ctx.strokeStyle = "#333";
    ctx.fillText(PointTime(time), BX, 30);
    time === 0 && ctx.fillText("".concat(unit.toFixed(1), "px/s"), BX, 42);
  } else {
    ctx.fillStyle = "#999";
    ctx.strokeStyle = "#888";
  }
...
function DrawTimeLine(ctx, _ref3) {
  var width = _ref3.width,
      height = _ref3.height,
      PxS = _ref3.PxS,
      unitPx = _ref3.unitPx,
      offsetTime = _ref3.offsetTime;
  ctx.clearRect(0, 0, width, height);
  var account = 0;
  var X = -(offsetTime * PxS);
  var h1 = height / 1.3;
  var h2 = height / 1.25;
  var h3 = height / 1.1;
  var duration_ = offsetTime + width / PxS;

  do {
    var Y = account % 5 === 0 ? account % 10 === 0 ? h1 : h2 : h3;
...
var VueTimelineCalipervue_type_script_lang_tsx_VueTimelineCaliperCaliper = /*#__PURE__*/function (_Vue) {
  ...
  _createClass(VueTimelineCaliperCaliper, [{
    ...
    value: function SetScrollTo() {
      var offsetTimeSync = this.offsetTimeSync,
          PxS = this.PxS;
      this.myContent.scrollTo(~~(offsetTimeSync * PxS), 0);
    }
  }, {
    key: "GetScroll",
    value: function GetScroll(event) {
      var div = event.target;
      this.offsetTimeSync = div.scrollLeft / this.PxS;
    }
  }, {
    key: "SetCurrentTime",
    value: function SetCurrentTime(_ref, flag) {
      var offsetX = _ref.offsetX,
          pageX = _ref.pageX;
      var PxS = this.PxS,
          offsetTimeSync = this.offsetTimeSync;
    ...
    value: function mounted() {
      ...
      var canvas = this.$refs.myTimeLine;
      canvas.width = width;
    ...
    value: function render() {
      ...
      var width = this.width,
          height = this.height,
          pointerTranslate3d = this.pointerTranslate3d,
          currentTimeStr = this.currentTimeStr,
    ...
    key: "pointerTranslate3d",
    get: function get() {
      var currentTimeSync = this.currentTimeSync,
          PxS = this.PxS;
      return "translate3d(".concat(currentTimeSync * PxS, "px, 0, 0)");
    }
  }]);
...
//# sourceMappingURL=vue-timeline-caliper.umd.js.map